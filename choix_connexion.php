...
if (isset($_SESSION["role"])) {
    ...
    // We do not auto-redirect so the user understands why what they clicked didn't work.
    // Instead they will see a specific state on this page.
} else {
    $role = null;
}
?>
...
<div class="choice-page">
    ...
    <div class="choice-inner">
        ...
        <h1>Choisissez votre<br><span class="grad">espace de travail</span></h1>
        <p class="sub">Connectez-vous au portail correspondant à votre profil pour accéder à toutes vos fonctionnalités.</p>
        ...
        <div class="portals">
            ...
            <?php else: ?>
                <a href="<?= PROJECT_PATH ?>auth/login.php?role=candidat" class="portal-btn">
                    <div class="portal-icon portal-icon-blue">
                        <i class="bi bi-person-bounding-box"></i>
                    </div>
                    <div class="portal-title">Espace Candidat</div>
                    <p class="portal-desc">Gérez votre CV, découvrez des opportunités et suivez vos candidatures en temps réel.</p>
                    <span class="portal-cta portal-cta-blue">Se connecter <i class="bi bi-arrow-right"></i></span>
                </a>

                <a href="<?= PROJECT_PATH ?>auth/login.php?role=gerant" class="portal-btn">
                    <div class="portal-icon portal-icon-green">
                        <i class="bi bi-buildings"></i>
                    </div>
                    <div class="portal-title">Espace Recruteur</div>
                    <p class="portal-desc">Publiez vos offres, évaluez les candidats et planifiez vos entretiens sereinement.</p>
                    <span class="portal-cta portal-cta-green">Se connecter <i class="bi bi-arrow-right"></i></span>
                </a>
            <?php endif; ?>
        </div>

        <?php if (!$role || $role !== 'admin'): ?>
        <a href="<?= PROJECT_PATH ?>auth/login.php?role=admin" class="admin-link">
            <i class="bi bi-shield-lock"></i> Portail d'administration sécurisé
        </a>
        <?php endif; ?>
    </div>
</div>
